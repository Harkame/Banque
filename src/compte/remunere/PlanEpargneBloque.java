package banque_executable.compte.remunere;
...
public class PlanEpargneBloque extends CompteRemunere {
	 ...
	 */
	public PlanEpargneBloque(String libelle, double solde,
			double taux_remuneration, double solde_plafond,
			Date DateAutorisation) throws OperationBancaireException {
		...
		System.out.println("                              - Solde : "
				+ this.getSolde());
		System.out
				.println("                              - Taux de remuneration : "
						+ this.getTaux_Remuneration());
		System.out.println("                              - Solde plafond : "
				+ this.getSoldePlafond());
		System.out
				.println("                              - Date autorisation : "
						+ this.getDate());
		System.out.println("");
	}
