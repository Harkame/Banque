package banque_executable.compte;

import java.util.ArrayList;

import banque_executable.operation.Operation;
...
public abstract class Compte {
	...
	public boolean equals(Compte compte) {
		return this.getidCompte() == compte.getidCompte()
				&& this.getLibelle() == compte.getLibelle()
				&& this.getSolde() == compte.getSolde();
	}
	...
	public void Debiter(double montant) {
		this.solde -= montant;
		System.out.println("Compte : " + this.getidCompte() + " debite de : "
				+ montant);
	}
	...
	public void Crediter(double montant) {
		this.solde += montant;
		System.out.println("Compte : " + this.getidCompte() + " credite de : "
				+ montant);
	}
	...
	public void ConsultationSolde() {
		System.out.println("Solde compte : " + this.getidCompte()
				+ " est de : " + this.solde);
	}
	...
	public void ConsultHistorique() {
		...
		for (int i = 0; i < this.getHistorique().size(); i++) {
			System.out.println("                  - iddentifiant : "
					+ this.historique.get(i).getidOperation());
			System.out.println("                  - Libelle : "
					+ this.historique.get(i).getLibelle());
			System.out.println("                  - Compte : "
					+ this.historique.get(i).getCompte().getidCompte());
			System.out.println("                  - Montant : "
					+ this.historique.get(i).getMontant());
			System.out.println("                  - Date : "
					+ this.historique.get(i).getDate());
			System.out.println("                  - Statut : "
					+ this.historique.get(i).getStatut());
			System.out.println("");
		}
	}
